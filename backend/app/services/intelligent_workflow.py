...
from app.models import Project, EvidenceRecord, ReviewDecision, ComparabilityScore
...
class IntelligentWorkflowService(BaseService):
    ...
    async def _calculate_efficiency_gain(
        ...
        pattern_analysis.get("average_time_per_step", 30)
...
class AIWorkflowAdvisor:
    ...
    async def generate_next_step_recommendations(
        ...
        step_result.get("automation_success", False)
