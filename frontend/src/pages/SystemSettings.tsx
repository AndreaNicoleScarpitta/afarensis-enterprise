        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-lg border shadow-sm overflow-hidden lg:sticky lg:top-8">
            {SECTIONS.map(section => (
              ...
              >
                <section.icon className={`w-4 h-4 flex-shrink-0 ${activeSection === section.id ? 'text-indigo-600' : 'text-gray-500'}`} />
                {section.label}
                <ChevronRight className={`w-3.5 h-3.5 ml-auto ${activeSection === section.id ? 'text-indigo-400' : 'text-gray-600'}`} />
              </button>
            ))}
          </div>
        </div>
            ...
            {activeSection === 'ai' && (
              <>
                ...
                <div className="space-y-5">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1.5">
                        Temperature <span className="text-gray-500">(0 = deterministic)</span>
                      </label>
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1.5">
                      Semantic Scholar API Key <span className="text-gray-500">(optional — 10 req/s with key, 1/s without)</span>
                    </label>
                    <div className="relative">
                      ...
                      />
                      <button onClick={() => setShowApiKey(v => !v)} className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 hover:text-gray-600">
                        {showApiKey ? <EyeOff className="w-4 h-4" /> : <Eye className="w-4 h-4" />}
                      </button>
                    </div>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1.5">PubMed API Key <span className="text-gray-500">(optional)</span></label>
            ...
            {activeSection === 'notifications' && (
              <>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1.5">Slack Webhook URL <span className="text-gray-500">(optional)</span></label>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                      ...
                      <input type="number" min={365} max={5000} value={settings.data_retention_days}
                        ...
                        className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                      <p className="text-xs text-gray-500 mt-1">FDA requires 7 years (2555 days) for GCP records</p>
                    </div>
                    <div>
              ...
              <>
                ...
                <div className="space-y-4">
                  ...
                  {settings.ip_allowlist_enabled && (
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1.5">IP Allowlist <span className="text-gray-500">(one per line)</span></label>
